---
title: "Features"
description: "Explore the major Suppio 2.0 features across agents, deployments, context, automation, analytics, and billing."
---

Suppio 2.0 is built around agents that can be deployed across multiple support surfaces.
...
<Columns cols={2}>
  ...
  <Card icon="boxes" title="Multiple deployments">
    Deploy agents to Discord, a web chat widget, a hosted support page, or your backend through the API.
  </Card>
  <Card icon="database" title="Context management">
    Add text, files, website pages, documentation sources, Discord forum posts, and followed channels.
  </Card>
  ...
  <Card icon="sliders" title="Behavior controls">
    Tune tone, response style, emoji usage, and custom instructions on supported plans.
  </Card>
...
| Hosted support page | A standalone support page hosted by Suppio, with optional custom DNS on Pro and Enterprise. | Shareable help pages and custom support subdomains. |
...
- custom learning notes from `/learn` and `/train`
...
- API access, Discord support, chat widget support, and core auto resolve and escalation are available on all plans.
...
- Analytics, personality controls, custom instructions, and advanced Discord automation require paid plans.
