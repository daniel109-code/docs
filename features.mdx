...
<Columns cols={2}>
  ...
  <Card icon="triangle-alert" title="Knowledge quality">
    Detect missing or conflicting context, review examples, and apply corrections on paid plans.
  </Card>
...
- Analytics, response images, knowledge gap detection, personality controls, custom instructions, and advanced Discord automation require paid plans.
