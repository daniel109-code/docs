...
The hosted support page is a public page served by Suppio for one agent. It includes a hero area, chat input, optional suggestions, optional link cards, theming, images, and attachment support.
...
<AccordionGroup>
  ...
  <Accordion title="Suggestions and link cards">
    Add suggested prompts and up to four link cards from the page editor.
  </Accordion>
</AccordionGroup>
