...
On paid plans, the handoff can also start a learning review. After the post is resolved, archived, locked, or deleted, Suppio can propose staff-confirmed guidance as a knowledge suggestion. Nothing is added to context until an authorized team member approves it.
