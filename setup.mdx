...
<Steps>
  ...
  <Step title="Add your website URL">
    Add your website URL when prompted. Suppio uses this to help understand the workspace and to make website context import easier.
  </Step>
  <Step title="Choose a plan">
    Choose the plan for the workspace. Billing is scoped to the workspace, not to individual users.
  </Step>
  <Step title="Add context">
    Add the information Suppio should use when answering. You can upload text or files, import website pages, connect documentation sources, or add Discord sources after Discord is connected.
  </Step>
  <Step title="Test in the sandbox">
    Use the agent sandbox to ask a few real support questions before launching.
  </Step>
  <Step title="Deploy">
    Open **Deploy** and choose Discord, chat widget, hosted support page, or API.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Hosted support page" icon="globe" href="/hosted-support-page">
...
<AccordionGroup>
  ...
  <Accordion title="Behavior">
    Set tone, personality, emoji usage, and custom instructions on supported plans.
  </Accordion>
  <Accordion title="Intelligence">
    Choose Smart or Advanced model access and reasoning settings based on your plan and quality needs.
  </Accordion>
