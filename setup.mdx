...
<AccordionGroup>
  ...
  <Accordion title="Sandbox intelligence">
    Compare Smart or Advanced model access and reasoning settings while testing. These controls apply to each sandbox message and are not a saved agent tab.
  </Accordion>
