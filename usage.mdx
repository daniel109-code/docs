...
- Compare Smart and Advanced model usage in the log.
...
<AccordionGroup>
  ...
  <Accordion title="Usage is higher than expected">
    Review **Conversations** and **All usage**, then check model choice, reasoning level, repeated commands, image inputs, and context-search activity.
  </Accordion>
