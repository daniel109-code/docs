...
You create a workspace, add one or more agents, give each agent context, and deploy those agents where your users need help: Discord, a web chat widget, a hosted support page, or your own backend through the API.
...
<AccordionGroup>
  ...
  <Accordion title="Context">
    Context is the knowledge Suppio uses to answer. It can include text, files, website pages, documentation sources, Discord forum posts, and followed channels.
  </Accordion>
  <Accordion title="Deployment">
    A deployment is where the agent is available to users. Suppio currently supports Discord, web chat widget, hosted support page, and API deployments.
  </Accordion>
</AccordionGroup>
