...
<AccordionGroup>
  ...
  <Accordion title="/train">
    Paid plans: review the current ticket or forum post and propose reusable facts, policies, procedures, and troubleshooting guidance stated or confirmed by staff. Customer-specific details are excluded.
